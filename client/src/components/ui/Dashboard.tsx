...
// import * as XLSX from "xlsx"; // Add this library via npm install xlsx

// // Define Expense interface locally to fix missing properties
// interface Expense {
//   _id: string;
//   account: string;
//   date: string;
...
//   const [filter, setFilter] = useState({ month: "", year: "", date: "" });
...
//     try {
//       setLoading(true);
//       const res = await instance.get("/api/dashboard", { params: filter });
//       const {
//         totalIncome,
//         totalExpenses,
//         totalProfit,
...
//       const expenseRes = await instance.get("/api/expense", { params: filter });
